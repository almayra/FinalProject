    ...
    render() {
        return (
            <div className='App-jumbotron3'>
                <div data-aos="fade-up" data-aos-duration="1000" style={{fontWeight:'bold',fontSize:'43px',color:'white',marginTop:'-0.5cm',marginLeft:'5.5cm'}}>
                    Mengapa Pesantren Kilat Copywriting?
                </div>
                <div data-aos="fade-up" data-aos-duration="1000">
                    <img
                    src={ICON9}
                    style={{width:'100px',height:'100px',marginLeft:'-40cm',marginTop:'3cm'}}
                    />
                    <div className='tulisan' style={{marginLeft:'-40cm', marginTop:'1cm'}}>
                    ...
                    src={LINE1}
                    style={{width:'8px',height:'6cm', marginLeft:'-30.8cm',marginTop:'-5cm'}}
                    />
                </div>
                <div data-aos="fade-up" data-aos-duration="2000">
                    <img
                    src={ICON10}
                    style={{width:'100px',height:'100px',marginLeft:'-20cm',marginTop:'3cm'}}
                    />
                    <div className='tulisan' style={{marginLeft:'-20cm', marginTop:'1cm'}}>
                    ...
                    src={LINE1}
                    style={{width:'8px',height:'6cm', marginLeft:'-8.5cm',marginTop:'-5.5cm'}}
                    />
                </div>
                <div data-aos="fade-up" data-aos-duration="3000">
                    <img
                    src={ICON11}
                    style={{width:'100px',height:'100px',marginLeft:'-3.5cm',marginTop:'3cm'}}
                    />
                    <div className='tulisan' style={{marginLeft:'-3.5cm', marginTop:'1cm'}}>
